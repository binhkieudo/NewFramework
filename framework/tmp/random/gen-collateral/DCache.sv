...
module DCache(
  ...
  wire             _GEN_18 = _T_320 & _T_336 & c_first;	// @[DCache.scala:651:26, :840:102, :856:41, :857:26, Decoupled.scala:51:35, Edges.scala:231:25, package.scala:73:59]
  always @(posedge clock) begin
    if (reset) begin
      ...
      uncachedInFlight_0 <= (~_io_errors_bus_valid_T | grantIsCached | ~(grantIsUncached & _T_284)) & (_GEN_17 | uncachedInFlight_0);	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :612:13, :651:26, :652:26, :661:35, :663:{17,28}, :665:13, Decoupled.scala:51:35, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[DCache.scala:1162:11]
      ...
      if (_GEN_19 & grantIsUncached & _T_284 & ~reset & ~uncachedInFlight_0) begin	// @[DCache.scala:213:33, :652:26, :663:17, :664:17, package.scala:73:59]
