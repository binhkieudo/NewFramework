...
module DCache(
  ...
  wire [5:0]       metaArb_io_in_5_bits_idx;	// @[DCache.scala:765:44]
  ...
  wire             _s1_victim_way_repl_array_ext_R0_data;	// @[DCache.scala:756:25]
  ...
  wire             _T_318 = release_state == 4'h1;	// @[DCache.scala:205:30, package.scala:16:47]
  wire             _T_317 = release_state == 4'h2;	// @[DCache.scala:205:30, package.scala:16:47]
  wire             inWriteback = _T_318 | _T_317;	// @[package.scala:16:47, :73:59]
  ...
  wire             _T_323 = release_state == 4'h9;	// @[DCache.scala:205:30, package.scala:16:47]
  wire             _canAcceptCachedGrant_T_4 = _T_318 | _metaArb_io_in_4_valid_T | _T_323;	// @[package.scala:16:47, :73:59]
  wire             _GEN_6 = _io_errors_bus_valid_T & grantIsCached;	// @[DCache.scala:652:26, Decoupled.scala:51:35, package.scala:73:59]
  wire             _T_286 = auto_out_d_bits_source & d_last;	// @[DCache.scala:663:17, Edges.scala:232:33]
  wire             _T_302 = grantIsRefill & dataArb_io_in_0_valid;	// @[DCache.scala:494:44, :699:23, package.scala:16:47]
  wire             tl_out_e_valid = ~_T_302 & auto_out_d_valid & ~(|counter) & grantIsCached & ~_canAcceptCachedGrant_T_4;	// @[DCache.scala:647:30, :691:18, :699:{23,51}, :700:20, Edges.scala:229:27, :231:25, package.scala:73:59]
  ...
  wire             _T_304 = grantIsUncachedData & (blockUncachedGrant | s1_valid);	// @[DCache.scala:159:25, :727:33, :729:{31,54}, package.scala:16:47]
  assign tl_out_d_ready = ~(_T_304 | _T_302) & (~grantIsCached | ((|counter) | auto_out_e_ready) & ~_canAcceptCachedGrant_T_4);	// @[DCache.scala:647:30, :648:{18,24,50,69}, :699:{23,51}, :701:20, :729:{31,68}, :730:22, Edges.scala:229:27, :231:25, package.scala:73:59]
  wire             _io_cpu_req_ready_output = _T_304 ? ~(auto_out_d_valid | _GEN_2) & _io_cpu_req_ready_T_4 : ~_GEN_2 & _io_cpu_req_ready_T_4;	// @[DCache.scala:210:{20,73}, :235:{45,64}, :244:{34,53}, :252:{79,98}, :729:{31,68}, :732:29, :733:26]
  wire             _GEN_7 = _T_304 & auto_out_d_valid;	// @[DCache.scala:698:26, :729:{31,68}, :732:29, :734:32]
  ...
  reg              s1_victim_way_s2_repl_state;	// @[DCache.scala:759:28]
  wire             s1_victim_way_s2_new_repl_state = s2_hit_way[1] & (s1_victim_way_s2_repl_state | s2_hit_way[1]);	// @[CircuitMath.scala:28:8, DCache.scala:759:28, Reg.scala:19:16, Replacement.scala:107:{15,67}]
  wire             s1_victim_way_s2_repl_wen = s2_valid_masked & (|s2_hit_way) & s1_victim_way_s2_repl_state != s1_victim_way_s2_new_repl_state;	// @[DCache.scala:314:42, :759:28, :761:{53,57,74}, Reg.scala:19:16, Replacement.scala:107:15]
  assign metaArb_io_in_5_bits_idx = flushCounter[5:0];	// @[DCache.scala:202:29, :765:44]
  wire             _T_338 = auto_out_c_ready & tl_out_c_valid;	// @[DCache.scala:801:21, :827:47, :828:22, :831:48, :832:22, Decoupled.scala:51:35]
  ...
  wire             releaseDone = (counter_1 == 9'h1 | beats1_1 == 9'h0) & _T_338;	// @[DCache.scala:267:18, Decoupled.scala:51:35, Edges.scala:221:14, :229:27, :232:{25,33,43}, :233:22]
  reg              s1_release_data_valid;	// @[DCache.scala:778:38]
  reg              s2_release_data_valid;	// @[DCache.scala:779:38]
  wire             releaseRejected = s2_release_data_valid & ~_T_338;	// @[DCache.scala:779:38, :780:{44,47}, Decoupled.scala:51:35]
  ...
  wire             _T_314 = release_state == 4'h4;	// @[DCache.scala:205:30, :804:23, :818:25]
  assign metaArb_io_in_6_valid = _T_314 | auto_out_b_valid & (~block_probe_for_core_progress | (|lrscCount) & ~(|(lrscCount[6:2])));	// @[DCache.scala:449:26, :450:29, :451:{34,40,43}, :743:71, :746:{26,44,48,79}, :818:{25,44}, :819:30]
  assign metaArb_io_in_6_bits_idx = _T_314 ? metaArb_io_in_4_bits_idx : auto_out_b_bits_address[11:6];	// @[DCache.scala:749:29, :818:{25,44}, :820:33, :1176:47]
  wire             _T_315 = release_state == 4'h5;	// @[DCache.scala:205:30, :814:29, :827:25]
  wire             _T_316 = release_state == 4'h3;	// @[DCache.scala:205:30, :810:29, :831:25]
  assign tl_out_c_valid = _T_316 | _T_315 | s2_probe & ~_GEN_9 | s2_release_data_valid & ~(c_first & release_ack_wait);	// @[DCache.scala:203:33, :310:25, :779:38, :787:{18,117,120,130}, :788:17, :801:21, :803:28, :805:36, :807:45, :827:{25,47}, :828:22, :831:{25,48}, :832:22, Edges.scala:231:25]
  wire             _T_322 = _T_318 | _metaArb_io_in_4_valid_T | _T_323;	// @[package.scala:16:47, :73:59]
  assign tl_out_c_bits_opcode = _T_322 ? {2'h3, ~_T_323} : {2'h2, _T_317};	// @[DCache.scala:831:48, :836:48, :837:21, :840:102, :841:52, :842:23, :847:23, TLB.scala:465:40, package.scala:16:47, :73:59]
  assign tl_out_c_bits_size = _T_322 ? 4'h6 : probe_bits_size;	// @[DCache.scala:836:48, :840:102, :841:52, Reg.scala:19:16, package.scala:16:47, :73:59]
  assign releaseWay = _T_322 ? metaArb_io_in_2_bits_way_en : s2_probe_way;	// @[DCache.scala:409:33, :790:14, :840:102, :854:18, Reg.scala:19:16, package.scala:73:59]
  ...
  assign metaArb_io_in_7_bits_data = {_T_322 ? 2'h0 : _GEN_4 ? 2'h2 : _T_174 ? 2'h1 : _T_170 ? 2'h0 : {1'h0, _T_166 | _T_162 | _T_158}, probe_bits_address[31:12]};	// @[DCache.scala:789:27, :840:102, :853:14, :890:{78,97}, Misc.scala:37:{36,63}, :55:20, Reg.scala:19:16, TLB.scala:465:40, package.scala:16:47, :73:59]
  ...
  wire             _GEN_11 = _T_314 & ~metaArb__grant_T_3;	// @[Arbiter.scala:45:{68,78}, DCache.scala:801:21, :818:{25,44}, :822:37, :823:23]
  wire [7:0]       flushCounterNext = {1'h0, flushCounter} + 8'h1;	// @[DCache.scala:202:29, :459:51, :985:39]
  wire [33:0]      s0_tlb_req_vaddr = {resetting ? {io_cpu_req_bits_addr[33:12], metaArb_io_in_5_bits_idx} : metaArb_io_in_1_valid ? {io_cpu_req_bits_addr[33:12], metaArb_io_in_1_bits_idx} : _GEN_1 ? {io_cpu_req_bits_addr[33:12], s2_req_addr[11:6]} : metaArb_io_in_4_valid ? {io_cpu_req_bits_addr[33:12], probe_bits_address[11:6]} : metaArb_io_in_6_valid ? {io_cpu_req_bits_addr[33:32], _T_314 ? probe_bits_address[31:6] : auto_out_b_bits_address[31:6]} : io_cpu_req_bits_addr[33:6], io_cpu_req_bits_addr[5:0]};	// @[Arbiter.scala:136:15, :138:26, :140:19, Cat.scala:33:92, DCache.scala:170:84, :201:26, :222:89, :316:19, :427:43, :430:35, :746:26, :750:{30,58}, :765:44, :818:{25,44}, :819:30, :821:34, Reg.scala:19:16, package.scala:73:59]
  wire             tlb_legal_address = s1_tlb_req_vaddr[33:12] == 22'h3 | s1_tlb_req_vaddr[33:12] == 22'h4 | s1_tlb_req_vaddr[33:12] == 22'h64000 | s1_tlb_req_vaddr[33:26] == 8'h3 | s1_tlb_req_vaddr[33:16] == 18'h200 | s1_tlb_req_vaddr[33:12] == 22'h0 | s1_tlb_req_vaddr[33:16] == 18'h1 | s1_tlb_req_vaddr[33:12] == 22'h100 | s1_tlb_req_vaddr[33:12] == 22'h110 | s1_tlb_req_vaddr[33:28] == 6'h8;	// @[DCache.scala:1026:85, Parameters.scala:137:{31,65}, Reg.scala:19:16, TLB.scala:410:67]
  ...
  wire [1:0]       _GEN_14 = {s1_tlb_req_vaddr[31], ~(s1_tlb_req_vaddr[26])};	// @[Parameters.scala:137:{31,45}, Reg.scala:19:16]
  wire             tlb_prot_pp = tlb_legal_address & (_GEN_12 == 3'h0 | _GEN_13 == 3'h0 | _GEN_14 == 2'h0 | s1_tlb_req_vaddr[31]);	// @[Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_prot_al = tlb_legal_address & (_GEN_12 == 3'h0 | _GEN_13 == 3'h0 | _GEN_14 == 2'h0);	// @[Parameters.scala:137:{45,65}, :616:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_prot_aa = tlb_legal_address & (_GEN_12 == 3'h0 | _GEN_13 == 3'h0 | _GEN_14 == 2'h0);	// @[Parameters.scala:137:{45,65}, :616:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire [3:0]       _GEN_15 = s1_tlb_req_vaddr[3:0] & (4'h1 << s1_tlb_req_size) - 4'h1;	// @[OneHot.scala:57:35, Reg.scala:19:16, TLB.scala:539:{39,69}, package.scala:16:47]
  ...
  wire             _GEN_16 = (|_GEN_15) & tlb_legal_address & ({s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[25], s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16], s1_tlb_req_vaddr[13]} == 5'h0 | {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[26:25], ~(s1_tlb_req_vaddr[20]), s1_tlb_req_vaddr[13]} == 5'h0 | {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[26:25] ^ 2'h1, s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16]} == 5'h0 | _GEN_14 == 2'h0) | tlb__cmd_lrsc_T_2 & ~tlb__cacheable_T_13;	// @[Parameters.scala:137:{31,45,65}, :616:89, Reg.scala:19:16, TLB.scala:410:67, :413:19, :539:{39,77}, :571:{8,37}, :572:{8,19}, package.scala:16:47, :73:59]
  wire             _s1_victim_way_s1_repl_state_T_1 = s1_victim_way_s2_repl_wen & metaArb_io_in_3_bits_idx == s1_req_addr[11:6];	// @[DCache.scala:430:76, :757:34, :761:57, :762:{41,56}, Reg.scala:19:16]
  ...
  wire             _GEN_17 = _io_cpu_perf_acquire_T & s2_uncached;	// @[DCache.scala:213:33, :401:39, :608:26, :609:24, :611:18, :612:13, Decoupled.scala:51:35]
  wire             _GEN_18 = _T_322 & _T_338 & c_first;	// @[DCache.scala:651:26, :840:102, :856:41, :857:26, Decoupled.scala:51:35, Edges.scala:231:25, package.scala:73:59]
  always @(posedge clock) begin
    if (reset) begin
      ...
      release_ack_wait <= _GEN_18 | (~_io_errors_bus_valid_T | grantIsCached | grantIsUncached | ~grantIsVoluntary) & release_ack_wait;	// @[DCache.scala:203:33, :608:26, :642:32, :651:26, :652:26, :684:36, :686:24, :840:102, :856:41, :857:26, Decoupled.scala:51:35, package.scala:73:59]
      if (~metaArb__grant_T_2 & metaArb_io_in_4_valid)	// @[Arbiter.scala:45:{68,78}, Decoupled.scala:51:35, package.scala:73:59]
        release_state <= 4'h0;	// @[DCache.scala:205:30]
      else if (_T_322 & releaseDone)	// @[DCache.scala:836:48, :840:102, :855:{26,42}, Edges.scala:233:22, package.scala:73:59]
        release_state <= 4'h6;	// @[DCache.scala:205:30, package.scala:16:47]
      else if (_T_317 & releaseDone | _T_316 & releaseDone)	// @[DCache.scala:827:47, :831:{25,48}, :834:{26,42}, :836:48, :838:{26,42}, Edges.scala:233:22, package.scala:16:47]
        release_state <= 4'h7;	// @[DCache.scala:205:30, :810:29]
      else if (_T_315 & releaseDone | _GEN_11)	// @[DCache.scala:801:21, :818:44, :822:37, :823:23, :827:{25,47}, :829:{26,42}, Edges.scala:233:22]
        release_state <= 4'h0;	// @[DCache.scala:205:30]
      ...
      uncachedInFlight_0 <= (~_io_errors_bus_valid_T | grantIsCached | ~(grantIsUncached & _T_286)) & (_GEN_17 | uncachedInFlight_0);	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :612:13, :651:26, :652:26, :661:35, :663:{17,28}, :665:13, Decoupled.scala:51:35, package.scala:73:59]
      ...
      if (_T_338) begin	// @[Decoupled.scala:51:35]
    ...
    if (_GEN_18)	// @[DCache.scala:651:26, :840:102, :856:41, :857:26]
    ...
    if (_GEN_17) begin	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :612:13]
    ...
    if (s1_valid_not_nacked) begin	// @[DCache.scala:164:38]
      ...
      s2_tlb_xcpt_ae_ld <= tlb_cmd_read & (_GEN_16 | ~(tlb_legal_address & ~tlb_deny_access_to_debug & _tlb_pmp_io_r));	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:403:19, :410:67, :418:50, :419:{44,66}, :571:37, :575:{24,44,46}]
      s2_tlb_xcpt_ae_st <= (tlb_cmd_write | s1_tlb_req_cmd == 5'h5 | s1_tlb_req_cmd == 5'h17) & (_GEN_16 | ~(tlb_legal_address & (_GEN_12 == 3'h0 | _GEN_13 == 3'h0 | _GEN_14 == 2'h0 | s1_tlb_req_vaddr[31]) & ~tlb_deny_access_to_debug & _tlb_pmp_io_w)) | tlb_cmd_put_partial & ~(tlb_prot_pp | tlb__cacheable_T_13) | tlb__cmd_amo_logical_T_6 & ~(tlb_prot_al | tlb__cacheable_T_13) | tlb__cmd_amo_arithmetic_T_8 & ~(tlb_prot_aa | tlb__cacheable_T_13);	// @[Consts.scala:86:76, DCache.scala:319:24, Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:403:19, :410:67, :413:19, :418:50, :419:44, :420:70, :533:39, :534:39, :535:39, :562:41, :566:35, :571:37, :577:{8,35,37}, :578:{8,26}, :579:{8,26,53}, :580:{8,29}, package.scala:16:47, :73:59]
      s2_tlb_xcpt_ma_ld <= (|_GEN_15) & tlb_cmd_read;	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:539:{39,77}, :634:31]
      s2_tlb_xcpt_ma_st <= (|_GEN_15) & tlb_cmd_write;	// @[Consts.scala:86:76, DCache.scala:319:24, TLB.scala:539:{39,77}, :635:31]
      ...
      s2_victim_way_r <= ~(_s1_victim_way_s1_repl_state_T_1 ? s1_victim_way_s2_new_repl_state : _s1_victim_way_repl_array_ext_R0_data);	// @[DCache.scala:756:25, :762:{28,41}, Reg.scala:19:16, Replacement.scala:107:15, :130:84]
      if (_s1_victim_way_s1_repl_state_T_1)	// @[DCache.scala:762:41]
        s1_victim_way_s2_repl_state <= s1_victim_way_s2_new_repl_state;	// @[DCache.scala:759:28, Replacement.scala:107:15]
      else	// @[DCache.scala:762:41]
        s1_victim_way_s2_repl_state <= _s1_victim_way_repl_array_ext_R0_data;	// @[DCache.scala:756:25, :759:28]
    end
  ...
  `ifndef SYNTHESIS
    wire         _GEN_19 = _io_errors_bus_valid_T & ~grantIsCached;	// @[DCache.scala:652:26, Decoupled.scala:51:35, package.scala:73:59]
    always @(posedge clock) begin	// @[DCache.scala:1162:11]
      ...
      if (_GEN_19 & grantIsUncached & _T_286 & ~reset & ~uncachedInFlight_0) begin	// @[DCache.scala:213:33, :652:26, :663:17, :664:17, package.scala:73:59]
      ...
      if (_GEN_19 & ~grantIsUncached & grantIsVoluntary & ~reset & ~release_ack_wait) begin	// @[DCache.scala:203:33, :642:32, :652:26, :661:35, :685:13, package.scala:73:59]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_82 = `RANDOM;
        _RANDOM_83 = `RANDOM;
        s1_valid = _RANDOM_38[14];	// @[DCache.scala:159:25]
        s1_probe = _RANDOM_38[15];	// @[DCache.scala:159:25, :160:25]
        probe_bits_param = _RANDOM_38[20:19];	// @[DCache.scala:159:25, Reg.scala:19:16]
        probe_bits_size = _RANDOM_38[24:21];	// @[DCache.scala:159:25, Reg.scala:19:16]
        probe_bits_source = _RANDOM_38[25];	// @[DCache.scala:159:25, Reg.scala:19:16]
        probe_bits_address = {_RANDOM_38[31:26], _RANDOM_39[25:0]};	// @[DCache.scala:159:25, Reg.scala:19:16]
        s1_req_addr = {_RANDOM_42[31:5], _RANDOM_43[6:0]};	// @[Reg.scala:19:16]
        s1_req_tag = _RANDOM_43[12:7];	// @[Reg.scala:19:16]
        ...
        cached_grant_wait = _RANDOM_51[17];	// @[DCache.scala:200:34]
        resetting = _RANDOM_51[18];	// @[DCache.scala:200:34, :201:26]
        flushCounter = _RANDOM_51[25:19];	// @[DCache.scala:200:34, :202:29]
        release_ack_wait = _RANDOM_51[26];	// @[DCache.scala:200:34, :203:33]
        release_ack_addr = {_RANDOM_51[31:27], _RANDOM_52[26:0]};	// @[DCache.scala:200:34, :204:29]
        release_state = _RANDOM_52[30:27];	// @[DCache.scala:204:29, :205:30]
        refill_way = {_RANDOM_52[31], _RANDOM_53[0]};	// @[DCache.scala:204:29, :206:23]
        uncachedInFlight_0 = _RANDOM_53[1];	// @[DCache.scala:206:23, :213:33]
        uncachedReqs_0_addr = {_RANDOM_53[31:2], _RANDOM_54[3:0]};	// @[DCache.scala:206:23, :214:25]
        uncachedReqs_0_tag = _RANDOM_54[9:4];	// @[DCache.scala:214:25]
        uncachedReqs_0_size = _RANDOM_54[16:15];	// @[DCache.scala:214:25]
        uncachedReqs_0_signed = _RANDOM_54[17];	// @[DCache.scala:214:25]
        s1_did_read = _RANDOM_57[0];	// @[Reg.scala:19:16]
        s1_read_mask = _RANDOM_57[1];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_57[2];	// @[DCache.scala:308:25, Reg.scala:19:16]
        s2_probe = _RANDOM_57[3];	// @[DCache.scala:310:25, Reg.scala:19:16]
        s2_not_nacked_in_s1 = _RANDOM_57[4];	// @[DCache.scala:312:36, Reg.scala:19:16]
        s2_req_addr = {_RANDOM_57[31:5], _RANDOM_58[6:0]};	// @[DCache.scala:316:19, Reg.scala:19:16]
        s2_req_tag = _RANDOM_58[12:7];	// @[DCache.scala:316:19]
        s2_req_cmd = _RANDOM_58[17:13];	// @[DCache.scala:316:19]
        s2_req_size = _RANDOM_58[19:18];	// @[DCache.scala:316:19]
        s2_req_signed = _RANDOM_58[20];	// @[DCache.scala:316:19]
        s2_req_dprv = _RANDOM_58[22:21];	// @[DCache.scala:316:19]
        s2_req_dv = _RANDOM_58[23];	// @[DCache.scala:316:19]
        s2_req_no_alloc = _RANDOM_58[25];	// @[DCache.scala:316:19]
        s2_req_no_xcpt = _RANDOM_58[26];	// @[DCache.scala:316:19]
        s2_req_mask = {_RANDOM_60[31:27], _RANDOM_61[2:0]};	// @[DCache.scala:316:19]
        s2_tlb_xcpt_pf_ld = _RANDOM_63[7];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_pf_st = _RANDOM_63[8];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_gf_ld = _RANDOM_63[10];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_gf_st = _RANDOM_63[11];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ae_ld = _RANDOM_63[13];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ae_st = _RANDOM_63[14];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ma_ld = _RANDOM_63[16];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ma_st = _RANDOM_63[17];	// @[DCache.scala:319:24]
        s2_pma_cacheable = _RANDOM_66[6];	// @[DCache.scala:320:19]
        s2_pma_must_alloc = _RANDOM_66[7];	// @[DCache.scala:320:19]
        s2_uncached_resp_addr = {_RANDOM_66[31:9], _RANDOM_67[10:0]};	// @[DCache.scala:320:19, :321:34]
        s2_vaddr_r = {_RANDOM_67[31:11], _RANDOM_68[12:0]};	// @[DCache.scala:321:34, Reg.scala:19:16]
        s2_meta_correctable_errors_r = _RANDOM_68[14];	// @[Reg.scala:19:16]
        s2_meta_correctable_errors_r_1 = _RANDOM_68[15];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r = _RANDOM_68[16];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r_1 = _RANDOM_68[17];	// @[Reg.scala:19:16]
        s2_meta_corrected_r = {_RANDOM_68[31:18], _RANDOM_69[7:0]};	// @[Reg.scala:19:16]
        s2_meta_corrected_r_1 = _RANDOM_69[29:8];	// @[Reg.scala:19:16]
        s2_data = {_RANDOM_69[31:30], _RANDOM_70, _RANDOM_71[29:0]};	// @[Reg.scala:19:16]
        s2_probe_way = _RANDOM_71[31:30];	// @[Reg.scala:19:16]
        s2_probe_state_state = _RANDOM_72[1:0];	// @[Reg.scala:19:16]
        s2_hit_way = _RANDOM_72[3:2];	// @[Reg.scala:19:16]
        s2_hit_state_state = _RANDOM_72[5:4];	// @[Reg.scala:19:16]
        s2_waw_hazard = _RANDOM_72[6];	// @[Reg.scala:19:16]
        s2_victim_way_r = _RANDOM_72[7];	// @[Reg.scala:19:16]
        lrscCount = _RANDOM_72[14:8];	// @[DCache.scala:449:26, Reg.scala:19:16]
        lrscAddr = {_RANDOM_72[31:15], _RANDOM_73[10:0]};	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_cmd = _RANDOM_73[16:12];	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_addr = {_RANDOM_73[31:17], _RANDOM_74[18:0]};	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_data = {_RANDOM_74[31:19], _RANDOM_75, _RANDOM_76[18:0]};	// @[Reg.scala:19:16]
        pstore1_way = _RANDOM_76[20:19];	// @[Reg.scala:19:16]
        pstore1_mask = _RANDOM_76[28:21];	// @[Reg.scala:19:16]
        pstore1_rmw_r = _RANDOM_76[29];	// @[Reg.scala:19:16]
        pstore2_valid = _RANDOM_76[30];	// @[DCache.scala:478:30, Reg.scala:19:16]
        pstore_drain_on_miss_REG = _RANDOM_76[31];	// @[DCache.scala:480:56, Reg.scala:19:16]
        pstore1_held = _RANDOM_77[0];	// @[DCache.scala:481:29]
        pstore2_addr = {_RANDOM_77[31:1], _RANDOM_78[2:0]};	// @[DCache.scala:481:29, Reg.scala:19:16]
        pstore2_way = _RANDOM_78[4:3];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r = _RANDOM_78[12:5];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_1 = _RANDOM_78[20:13];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_2 = _RANDOM_78[28:21];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_3 = {_RANDOM_78[31:29], _RANDOM_79[4:0]};	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_4 = _RANDOM_79[12:5];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_5 = _RANDOM_79[20:13];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_6 = _RANDOM_79[28:21];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_7 = {_RANDOM_79[31:29], _RANDOM_80[4:0]};	// @[Reg.scala:19:16]
        pstore2_storegen_mask = _RANDOM_80[12:5];	// @[DCache.scala:508:19, Reg.scala:19:16]
        counter = _RANDOM_80[22:14];	// @[Edges.scala:229:27, Reg.scala:19:16]
        grantInProgress = _RANDOM_80[23];	// @[DCache.scala:644:32, Reg.scala:19:16]
        blockProbeAfterGrantCount = _RANDOM_80[26:24];	// @[DCache.scala:645:42, Reg.scala:19:16]
        blockUncachedGrant = _RANDOM_80[27];	// @[DCache.scala:727:33, Reg.scala:19:16]
        s1_victim_way_s2_repl_state = _RANDOM_80[28];	// @[DCache.scala:759:28, Reg.scala:19:16]
        counter_1 = {_RANDOM_80[31:29], _RANDOM_81[5:0]};	// @[Edges.scala:229:27, Reg.scala:19:16]
        s1_release_data_valid = _RANDOM_81[6];	// @[DCache.scala:778:38, Edges.scala:229:27]
        s2_release_data_valid = _RANDOM_81[7];	// @[DCache.scala:779:38, Edges.scala:229:27]
        io_cpu_s2_xcpt_REG = _RANDOM_81[8];	// @[DCache.scala:909:32, Edges.scala:229:27]
        doUncachedResp = _RANDOM_83[9];	// @[DCache.scala:924:31]
        REG = _RANDOM_83[10];	// @[DCache.scala:924:31, :984:18]
        io_cpu_perf_release_counter = _RANDOM_83[28:20];	// @[DCache.scala:924:31, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array tag_array (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (resetting ? metaArb_io_in_5_bits_idx : metaArb_io_in_1_valid ? metaArb_io_in_1_bits_idx : _GEN_1 ? metaArb_io_in_3_bits_idx : metaArb_io_in_4_valid ? metaArb_io_in_4_bits_idx : metaArb_io_in_6_valid ? metaArb_io_in_6_bits_idx : metaArb_io_in_7_bits_idx),	// @[Arbiter.scala:136:15, :138:26, :140:19, DCache.scala:201:26, :240:58, :427:43, :430:{35,76}, :746:26, :749:29, :765:44, :818:44, :819:30, :820:33, :1176:47, package.scala:73:59]
  ...
  s1_victim_way_repl_array_combMem s1_victim_way_repl_array_ext (	// @[DCache.scala:756:25]
    .R0_addr (s1_req_addr[11:6]),	// @[DCache.scala:757:34, Reg.scala:19:16]
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (resetting ? metaArb_io_in_5_bits_idx : metaArb_io_in_3_bits_idx),	// @[DCache.scala:201:26, :430:76, :765:{20,44}]
    .W0_en   (resetting | s1_victim_way_s2_repl_wen),	// @[DCache.scala:201:26, :761:57, :767:25]
    .W0_clk  (clock),
    .W0_data (~resetting & s1_victim_way_s2_new_repl_state),	// @[DCache.scala:201:26, :766:20, Replacement.scala:107:15]
    .R0_data (_s1_victim_way_repl_array_ext_R0_data)
  );
  ...
  assign auto_out_c_bits_param = _T_322 ? ((&s2_victim_state_state) | s2_victim_state_state == 2'h2 ? 3'h1 : s2_victim_state_state == 2'h1 ? 3'h2 : s2_victim_state_state == 2'h0 ? 3'h5 : 3'h0) : _T_317 | _T_316 | ~(~s2_probe | _GEN_9 | ~(|s2_probe_state_state)) ? (_GEN_4 ? 3'h3 : _T_174 ? 3'h4 : _T_170 ? 3'h5 : _T_166 | _T_162 ? 3'h0 : _T_158 ? 3'h4 : _T_154 ? 3'h5 : _T_151 | _T_125 == 4'hA ? 3'h1 : _T_125 == 4'h9 ? 3'h2 : _T_125 == 4'h8 ? 3'h5 : 3'h0) : 3'h5;	// @[Cat.scala:33:92, DCache.scala:310:25, :411:28, :788:17, :801:21, :803:28, :805:36, :807:45, :831:{25,48}, :833:21, :836:48, :837:21, :840:102, :841:52, Metadata.scala:50:45, Misc.scala:37:36, :55:20, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:465:40, package.scala:16:47, :73:59]
  ...
  assign io_cpu_perf_release = (io_cpu_perf_release_counter == 9'h1 | (tl_out_c_bits_opcode[0] ? ~(_io_cpu_perf_release_beats1_decode_T_1[11:3]) : 9'h0) == 9'h0) & _T_338;	// @[DCache.scala:267:18, :836:48, :840:102, :841:52, Decoupled.scala:51:35, Edges.scala:102:36, :221:14, :229:27, :232:{25,33,43}, :233:22, package.scala:235:{46,71,76}]
