...
module Queue_53(
  ...
  wire [86:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_15 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_user_amba_prot_fetch, io_enq_bits_user_amba_prot_secure, io_enq_bits_user_amba_prot_privileged, io_enq_bits_user_amba_prot_writealloc, io_enq_bits_user_amba_prot_readalloc, io_enq_bits_user_amba_prot_modifiable, io_enq_bits_user_amba_prot_bufferable, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[43];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[44];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[45];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[49];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[53:50];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[85:54];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[86];	// @[Decoupled.scala:273:95]
endmodule
