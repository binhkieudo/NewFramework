...
module TLXbar_8(
  ...
  wire        x1_out_1_bits_user_amba_prot_fetch = idle ? earlyWinner_1 : state_1;	// @[Arbiter.scala:89:28, :98:79, :117:26, :118:30]
  ...
  assign auto_in_1_d_valid = auto_out_d_valid & ~auto_out_d_bits_source;	// @[Parameters.scala:46:9, Xbar.scala:182:40]
  ...
  assign auto_in_0_d_valid = auto_out_d_valid & auto_out_d_bits_source;	// @[Xbar.scala:182:40]
  assign auto_in_0_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_0_d_bits_size = auto_out_d_bits_size;
  assign auto_in_0_d_bits_denied = auto_out_d_bits_denied;
  assign auto_in_0_d_bits_data = auto_out_d_bits_data;
  assign auto_out_a_valid = x1_out_1_valid;	// @[Arbiter.scala:126:29]
  assign auto_out_a_bits_opcode = (x1_out_1_bits_source ? auto_in_0_a_bits_opcode : 3'h0) | {x1_out_1_bits_user_amba_prot_fetch, 2'h0};	// @[Arbiter.scala:26:66, :118:30, Mux.scala:27:73]
  assign auto_out_a_bits_param = x1_out_1_bits_source ? auto_in_0_a_bits_param : 3'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_size = (x1_out_1_bits_source ? auto_in_0_a_bits_size : 4'h0) | (x1_out_1_bits_user_amba_prot_fetch ? 4'h6 : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = x1_out_1_bits_source;	// @[Arbiter.scala:118:30]
  assign auto_out_a_bits_address = (x1_out_1_bits_source ? auto_in_0_a_bits_address : 32'h0) | (x1_out_1_bits_user_amba_prot_fetch ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_bufferable = x1_out_1_bits_source & auto_in_0_a_bits_user_amba_prot_bufferable | x1_out_1_bits_user_amba_prot_fetch;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_modifiable = x1_out_1_bits_source & auto_in_0_a_bits_user_amba_prot_modifiable | x1_out_1_bits_user_amba_prot_fetch;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_readalloc = x1_out_1_bits_source & auto_in_0_a_bits_user_amba_prot_readalloc | x1_out_1_bits_user_amba_prot_fetch & auto_in_1_a_bits_user_amba_prot_readalloc;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_writealloc = x1_out_1_bits_source & auto_in_0_a_bits_user_amba_prot_writealloc | x1_out_1_bits_user_amba_prot_fetch & auto_in_1_a_bits_user_amba_prot_writealloc;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_privileged = x1_out_1_bits_source & auto_in_0_a_bits_user_amba_prot_privileged | x1_out_1_bits_user_amba_prot_fetch;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_secure = x1_out_1_bits_source | x1_out_1_bits_user_amba_prot_fetch;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_user_amba_prot_fetch = x1_out_1_bits_user_amba_prot_fetch;	// @[Arbiter.scala:118:30]
  assign auto_out_a_bits_mask = (x1_out_1_bits_source ? auto_in_0_a_bits_mask : 4'h0) | {4{x1_out_1_bits_user_amba_prot_fetch}};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
