...
module TLUART(
  ...
  wire             _out_out_bits_data_WIRE_6 = auto_control_xing_in_a_bits_address[11:5] == 7'h0;	// @[Edges.scala:192:34, RegisterRouter.scala:73:19, :83:24]
  ...
  wire [7:0][31:0] _GEN_0 = {{32'h0}, {{16'h0, div}}, {{30'h0, ip_rxwm, ip_txwm}}, {{30'h0, ie_rxwm, ie_txwm}}, {{12'h0, rxwm, 15'h0, rxen}}, {{12'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits}}, {{~_txq_io_enq_ready, 31'h0}}};	// @[Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:83:24, UART.scala:131:19, :134:19, :136:20, :142:21, :143:21, :150:21, :151:21, :152:22, :186:19, :189:28, :190:28]
  always @(posedge clock) begin
    if (reset) begin
      ...
      txwm <= 4'h0;	// @[Bundles.scala:259:74, UART.scala:150:21]
      rxwm <= 4'h0;	// @[Bundles.scala:259:74, UART.scala:151:21]
      ...
      if (out_woready_11 & auto_control_xing_in_a_bits_mask[2])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        txwm <= auto_control_xing_in_a_bits_data[19:16];	// @[RegisterRouter.scala:83:24, UART.scala:150:21]
      if (out_woready_13 & auto_control_xing_in_a_bits_mask[2])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        rxwm <= auto_control_xing_in_a_bits_data[19:16];	// @[RegisterRouter.scala:83:24, UART.scala:151:21]
      if (out_woready_11 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
  ...
  Queue_58 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_58 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
