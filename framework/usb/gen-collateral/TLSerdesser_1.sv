...
module TLSerdesser_1(
  ...
  HellaPeekingArbiter_VC707woDDRHarness_UNIQUIFIED outArb (	// @[Serdes.scala:638:24]
    .clock                (clock),
    .reset                (reset),
  ...
  GenericSerializer_VC707woDDRHarness_UNIQUIFIED outSer (	// @[Serdes.scala:640:24]
    .clock              (clock),
    .reset              (reset),
  ...
  GenericDeserializer_VC707woDDRHarness_UNIQUIFIED inDes (	// @[Serdes.scala:645:23]
    .clock               (clock),
    .reset               (reset),
