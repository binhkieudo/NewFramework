...
module TLInterconnectCoupler_16(
  ...
  wire [6:0]  _tl2axi4_auto_out_aw_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [6:0]  _tl2axi4_auto_out_aw_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  ...
  wire [6:0]  _tl2axi4_auto_out_ar_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [6:0]  _tl2axi4_auto_out_ar_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  ...
  wire [6:0]  _axi4index_auto_in_b_bits_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [6:0]  _axi4index_auto_in_b_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_ar_ready;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_r_valid;	// @[IdIndexer.scala:94:31]
  wire [6:0]  _axi4index_auto_in_r_bits_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [6:0]  _axi4index_auto_in_r_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [6:0]  _axi4index_auto_out_aw_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [6:0]  _axi4index_auto_out_ar_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [6:0]  _axi4yank_auto_in_b_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
  ...
  wire [6:0]  _axi4yank_auto_in_r_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
  ...
  TLToAXI4 tl2axi4 (	// @[ToAXI4.scala:286:29]
    ...
    .auto_in_a_bits_user_amba_prot_bufferable (auto_widget_in_a_bits_user_amba_prot_bufferable),
    .auto_in_a_bits_user_amba_prot_modifiable (auto_widget_in_a_bits_user_amba_prot_modifiable),
    .auto_in_a_bits_user_amba_prot_readalloc  (auto_widget_in_a_bits_user_amba_prot_readalloc),
    .auto_in_a_bits_user_amba_prot_writealloc (auto_widget_in_a_bits_user_amba_prot_writealloc),
    .auto_in_a_bits_user_amba_prot_privileged (auto_widget_in_a_bits_user_amba_prot_privileged),
    .auto_in_a_bits_user_amba_prot_secure     (auto_widget_in_a_bits_user_amba_prot_secure),
    .auto_in_a_bits_user_amba_prot_fetch      (auto_widget_in_a_bits_user_amba_prot_fetch),
