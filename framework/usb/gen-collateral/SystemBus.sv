...
module SystemBus(
  ...
  input         auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_bufferable,
  ...
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_bufferable;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_modifiable;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_readalloc;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_writealloc;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_privileged;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_secure;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_out_1_a_bits_user_amba_prot_fetch;	// @[FIFOFixer.scala:146:27]
  ...
  TLXbar system_bus_xbar (	// @[SystemBus.scala:40:43]
    ...
    .auto_in_1_a_bits_user_amba_prot_bufferable  (_fixer_auto_out_1_a_bits_user_amba_prot_bufferable),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_modifiable  (_fixer_auto_out_1_a_bits_user_amba_prot_modifiable),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_readalloc   (_fixer_auto_out_1_a_bits_user_amba_prot_readalloc),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_writealloc  (_fixer_auto_out_1_a_bits_user_amba_prot_writealloc),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_privileged  (_fixer_auto_out_1_a_bits_user_amba_prot_privileged),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_secure      (_fixer_auto_out_1_a_bits_user_amba_prot_secure),	// @[FIFOFixer.scala:146:27]
    .auto_in_1_a_bits_user_amba_prot_fetch       (_fixer_auto_out_1_a_bits_user_amba_prot_fetch),	// @[FIFOFixer.scala:146:27]
    ...
    .auto_out_1_a_bits_user_amba_prot_bufferable (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_bufferable),
    .auto_out_1_a_bits_user_amba_prot_modifiable (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_modifiable),
    .auto_out_1_a_bits_user_amba_prot_readalloc  (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_readalloc),
    .auto_out_1_a_bits_user_amba_prot_writealloc (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_writealloc),
    .auto_out_1_a_bits_user_amba_prot_privileged (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_privileged),
    .auto_out_1_a_bits_user_amba_prot_secure     (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_secure),
    .auto_out_1_a_bits_user_amba_prot_fetch      (auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_user_amba_prot_fetch),
  ...
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:146:27]
    ...
    .auto_in_1_a_bits_user_amba_prot_bufferable  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_bufferable),
    .auto_in_1_a_bits_user_amba_prot_modifiable  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_modifiable),
    .auto_in_1_a_bits_user_amba_prot_readalloc   (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_readalloc),
    .auto_in_1_a_bits_user_amba_prot_writealloc  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_writealloc),
    .auto_in_1_a_bits_user_amba_prot_privileged  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_privileged),
    .auto_in_1_a_bits_user_amba_prot_secure      (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_secure),
    .auto_in_1_a_bits_user_amba_prot_fetch       (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_user_amba_prot_fetch),
    ...
    .auto_out_1_a_bits_user_amba_prot_bufferable (_fixer_auto_out_1_a_bits_user_amba_prot_bufferable),
    .auto_out_1_a_bits_user_amba_prot_modifiable (_fixer_auto_out_1_a_bits_user_amba_prot_modifiable),
    .auto_out_1_a_bits_user_amba_prot_readalloc  (_fixer_auto_out_1_a_bits_user_amba_prot_readalloc),
    .auto_out_1_a_bits_user_amba_prot_writealloc (_fixer_auto_out_1_a_bits_user_amba_prot_writealloc),
    .auto_out_1_a_bits_user_amba_prot_privileged (_fixer_auto_out_1_a_bits_user_amba_prot_privileged),
    .auto_out_1_a_bits_user_amba_prot_secure     (_fixer_auto_out_1_a_bits_user_amba_prot_secure),
    .auto_out_1_a_bits_user_amba_prot_fetch      (_fixer_auto_out_1_a_bits_user_amba_prot_fetch),
