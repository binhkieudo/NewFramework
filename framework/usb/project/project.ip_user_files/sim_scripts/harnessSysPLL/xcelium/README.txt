...
#
# Generated by export_simulation on Fri May 31 04:19:09 JST 2024
#
################################################################################
...
'-reset_run' switch to the './harnessSysPLL.sh' script.

./harnessSysPLL.sh -reset_run
...
./harnessSysPLL.sh -noclean_files

For more information on the script, please type './harnessSysPLL.sh -help'.
