...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/NewFramework/framework/usb/project/project.runs/harnessSysPLL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harnessSysPLL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harnessSysPLL.tcl
