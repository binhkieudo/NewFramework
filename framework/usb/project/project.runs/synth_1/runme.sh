...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/NewFramework/framework/usb/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VC707woDDRHarness.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VC707woDDRHarness.tcl
