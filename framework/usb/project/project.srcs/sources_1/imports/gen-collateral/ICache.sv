...
module ICache(
  ...
  output        auto_master_out_a_bits_user_amba_prot_readalloc,
  ...
  assign auto_master_out_a_bits_user_amba_prot_readalloc = io_s2_cacheable;
  assign auto_master_out_a_bits_user_amba_prot_writealloc = io_s2_cacheable;
