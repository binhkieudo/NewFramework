...
module VC707woDDRHarness(
  ...
  wire aw_valid = (_chiptop0_axi4_mem_0_bits_aw_bits_addr[31:28] == 4'b1000) && _chiptop0_axi4_mem_0_bits_aw_valid;
  wire ar_valid = (_chiptop0_axi4_mem_0_bits_ar_bits_addr[31:28] == 4'b1000) && _chiptop0_axi4_mem_0_bits_ar_valid;
  
  axi_bram_ctrl_0 bram (
    .s_axi_aclk     ( _chiptop0_axi4_mem_0_clock                    ), // in
    .s_axi_aresetn  ( _chiptop0_axi4_mem_0_reset                    ), // in
    // aw side
    .s_axi_awid     (_chiptop0_axi4_mem_0_bits_aw_bits_id           ), // in [3:0]
    .s_axi_awaddr   (_chiptop0_axi4_mem_0_bits_aw_bits_addr[14:0]   ), // in [14:0]
    .s_axi_awlen    (_chiptop0_axi4_mem_0_bits_aw_bits_len          ), // in [7:0]
    .s_axi_awsize   ({1'b0, _chiptop0_axi4_mem_0_bits_aw_bits_size} ), // in [3:0]
    .s_axi_awburst  (_chiptop0_axi4_mem_0_bits_aw_bits_burst        ), // in [1:0]
    .s_axi_awlock   (_chiptop0_axi4_mem_0_bits_aw_bits_lock         ), // in
    .s_axi_awcache  (_chiptop0_axi4_mem_0_bits_aw_bits_cache        ), // in [3:0]
    .s_axi_awprot   (_chiptop0_axi4_mem_0_bits_aw_bits_prot         ), // in [2:0]
    .s_axi_awvalid  (aw_valid                                       ), // in
    .s_axi_awready  (_simdram_axi_aw_ready                          ), // out
    // w side
    .s_axi_wdata    (_chiptop0_axi4_mem_0_bits_w_bits_data          ), // in [31:0]
    .s_axi_wstrb    (_chiptop0_axi4_mem_0_bits_w_bits_strb          ), // in [3:0]
    .s_axi_wlast    (_chiptop0_axi4_mem_0_bits_w_bits_last          ), // in
    .s_axi_wvalid   (_chiptop0_axi4_mem_0_bits_w_valid              ), // in
    .s_axi_wready   (_simdram_axi_w_ready                           ), // out
    // b side
    .s_axi_bid      (_simdram_axi_b_bits_id                         ), // out [3:0]
    .s_axi_bresp    (_simdram_axi_b_bits_resp                       ), // out [1:0]
    .s_axi_bvalid   (_simdram_axi_b_valid                           ), // out
    .s_axi_bready   (_chiptop0_axi4_mem_0_bits_b_ready              ), // in
    // ar side
    .s_axi_arid     (_chiptop0_axi4_mem_0_bits_ar_bits_id           ), // in [3:0]
    .s_axi_araddr   (_chiptop0_axi4_mem_0_bits_ar_bits_addr[14:0]   ), // in [14:0]
    .s_axi_arlen    (_chiptop0_axi4_mem_0_bits_ar_bits_len          ), // in [7:0]
    .s_axi_arsize   (_chiptop0_axi4_mem_0_bits_ar_bits_size         ), // in [2:0]
    .s_axi_arburst  (_chiptop0_axi4_mem_0_bits_ar_bits_burst        ), // in [1:0]
    .s_axi_arlock   (_chiptop0_axi4_mem_0_bits_ar_bits_lock         ), // in
    .s_axi_arcache  (_chiptop0_axi4_mem_0_bits_ar_bits_cache        ), // in [3:0]
    .s_axi_arprot   (_chiptop0_axi4_mem_0_bits_ar_bits_prot         ), // in [2:0]
    .s_axi_arvalid  (ar_valid                                       ), // in
    .s_axi_arready  (_simdram_axi_ar_ready                          ), // out
    // r side
    .s_axi_rid      (_simdram_axi_r_bits_id                         ), // out [3:0]
    .s_axi_rdata    (_simdram_axi_r_bits_data                       ), // out [31:0]
    .s_axi_rresp    (_simdram_axi_r_bits_resp                       ), // out [1:0]
    .s_axi_rlast    (_simdram_axi_r_bits_last                       ), // out
    .s_axi_rvalid   (_simdram_axi_r_valid                           ), // out
    .s_axi_rready   (_chiptop0_axi4_mem_0_bits_r_ready              )  // in
  );
