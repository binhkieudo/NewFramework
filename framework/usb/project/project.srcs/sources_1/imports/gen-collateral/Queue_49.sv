...
module Queue_49(
  ...
  wire [35:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[3:0];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[35:4];	// @[Decoupled.scala:273:95]
endmodule
