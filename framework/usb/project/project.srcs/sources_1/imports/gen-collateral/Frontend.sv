...
module Frontend(
  ...
  output        auto_icache_master_out_a_bits_user_amba_prot_readalloc,
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      s2_pc <= 32'h10000;	// @[Frontend.scala:112:22]
  ...
  ICache icache (	// @[Frontend.scala:65:26]
    ...
    .io_s2_cacheable                                  (s2_tlb_resp_cacheable),	// @[Frontend.scala:116:24]
