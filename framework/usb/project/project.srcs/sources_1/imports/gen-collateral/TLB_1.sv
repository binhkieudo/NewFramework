...
module TLB_1(
  ...
  wire        legal_address = io_req_bits_vaddr[31:12] == 20'h3 | io_req_bits_vaddr[31:12] == 20'h4 | io_req_bits_vaddr[31:12] == 20'h64000 | io_req_bits_vaddr[31:12] == 20'h64001 | io_req_bits_vaddr[31:26] == 6'h3 | io_req_bits_vaddr[31:16] == 16'h200 | io_req_bits_vaddr[31:14] == 18'h24000 | io_req_bits_vaddr[31:12] == 20'h0 | io_req_bits_vaddr[31:16] == 16'h1 | io_req_bits_vaddr[31:12] == 20'h100 | io_req_bits_vaddr[31:12] == 20'h110 | io_req_bits_vaddr[31:28] == 4'h8;	// @[Parameters.scala:137:{31,65}, TLB.scala:410:67]
  ...
  assign io_resp_ae_inst = ~(legal_address & ({io_req_bits_vaddr[26:25], io_req_bits_vaddr[20], io_req_bits_vaddr[16], io_req_bits_vaddr[14]} == 5'h0 | {io_req_bits_vaddr[31], io_req_bits_vaddr[26:25], io_req_bits_vaddr[20], ~(io_req_bits_vaddr[16])} == 5'h0 | io_req_bits_vaddr[31]) & ~(~io_ptw_status_debug & io_req_bits_vaddr[31:12] == 20'h0) & _pmp_io_x);	// @[Parameters.scala:137:{31,45,65}, :616:89, TLB.scala:403:19, :410:67, :418:{39,50}, :419:44, :424:65, :632:23]
  assign io_resp_cacheable = legal_address & {~(io_req_bits_vaddr[31]), io_req_bits_vaddr[28]} == 2'h0;	// @[Parameters.scala:137:{31,45,65}, TLB.scala:410:67, :413:19]
endmodule
