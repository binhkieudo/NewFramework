...
module Queue_11(
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[32:29];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[64:33];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[65];	// @[Decoupled.scala:273:95]
endmodule
