...
module TLSPI(
  ...
  wire              out_woready_10;	// @[RegisterRouter.scala:83:24]
  ...
  wire              _out_out_bits_data_WIRE_29 = auto_control_xing_in_a_bits_address[11:7] == 5'h0;	// @[Edges.scala:192:34, RegisterRouter.scala:73:19, :83:24]
  assign quash = out_woready_10 & auto_control_xing_in_a_bits_mask[3] & auto_control_xing_in_a_bits_data[31];	// @[Bitwise.scala:28:17, RegMapFIFO.scala:26:26, RegisterRouter.scala:83:24]
  assign out_backSel_19 = auto_control_xing_in_a_bits_address[6:2] == 5'h13;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  ...
  wire              out_woready_6 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h1 & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire              out_woready_3 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'hA & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire              out_woready_16 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'hB & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire              out_woready_14 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h10 & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_woready_10 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h12 & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire              out_woready_26 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h1C & _out_out_bits_data_WIRE_29;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire [31:0]       _GEN = {{1'h1}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {1'h1}, {1'h1}, {1'h1}, {1'h1}, {1'h1}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {1'h1}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {1'h1}, {1'h1}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}, {1'h1}, {1'h1}, {_out_out_bits_data_WIRE_29}, {_out_out_bits_data_WIRE_29}};	// @[Buffer.scala:47:20, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
  wire [31:0][31:0] _GEN_0 = {{32'h0}, {32'h0}, {{30'h0, _fifo_io_ip_rxwm, _fifo_io_ip_txwm}}, {{30'h0, ie_rxwm, ie_txwm}}, {32'h0}, {32'h0}, {32'h0}, {32'h0}, {32'h0}, {32'h0}, {{28'h0, ctrl_wm_rx}}, {{28'h0, ctrl_wm_tx}}, {{~_fifo_io_rx_valid, 23'h0, _fifo_io_rx_bits}}, {{~_fifo_io_tx_ready, 31'h0}}, {32'h0}, {{12'h0, ctrl_fmt_len, 12'h0, ctrl_fmt_iodir, ctrl_fmt_endian, ctrl_fmt_proto}}, {{27'h0, ctrl_sampledel_sd}}, {{20'h0, ctrl_extradel_coarse}}, {32'h0}, {32'h0}, {{8'h0, ctrl_dla_interxfr, 8'h0, ctrl_dla_intercs}}, {{8'h0, ctrl_dla_sckcs, 8'h0, ctrl_dla_cssck}}, {32'h0}, {32'h0}, {32'h0}, {{30'h0, ctrl_cs_mode}}, {{31'h0, ctrl_cs_dflt_0}}, {{31'h0, ctrl_cs_id}}, {32'h0}, {32'h0}, {{30'h0, ctrl_sck_pol, ctrl_sck_pha}}, {{20'h0, ctrl_sck_div}}};	// @[Bitwise.scala:77:12, Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, OneHot.scala:57:35, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:83:24, TLSPI.scala:67:17, :68:20, :81:15]
  wire [11:0]       _out_womask_T_4 = {{4{auto_control_xing_in_a_bits_mask[1]}}, {8{auto_control_xing_in_a_bits_mask[0]}}};	// @[Bitwise.scala:28:17, :77:12, RegisterRouter.scala:83:24]
  always @(posedge clock) begin
    if (reset) begin
      ...
      ctrl_dla_interxfr <= 8'h0;	// @[Bitwise.scala:77:12, TLSPI.scala:67:17]
      ctrl_wm_tx <= 4'h0;	// @[Bundles.scala:259:74, TLSPI.scala:67:17]
      ctrl_wm_rx <= 4'h0;	// @[Bundles.scala:259:74, TLSPI.scala:67:17]
      ...
      if (out_woready_14 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
      ...
      if (out_woready_14 & auto_control_xing_in_a_bits_mask[2])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_fmt_len <= auto_control_xing_in_a_bits_data[19:16];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h0 & _out_out_bits_data_WIRE_29 & (&_out_womask_T_4))	// @[Cat.scala:33:92, RegisterRouter.scala:83:24]
      ...
      if (out_woready_6 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_sck_pol <= auto_control_xing_in_a_bits_data[1];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_6 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_sck_pha <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h4 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_cs_id <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h5 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_cs_dflt_0 <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h6 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_cs_mode <= auto_control_xing_in_a_bits_data[1:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_3 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_dla_cssck <= auto_control_xing_in_a_bits_data[7:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_3 & auto_control_xing_in_a_bits_mask[2])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_dla_sckcs <= auto_control_xing_in_a_bits_data[23:16];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_16 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_dla_intercs <= auto_control_xing_in_a_bits_data[7:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_16 & auto_control_xing_in_a_bits_mask[2])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        ctrl_dla_interxfr <= auto_control_xing_in_a_bits_data[23:16];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h14 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_wm_tx <= auto_control_xing_in_a_bits_data[3:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'h15 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_wm_rx <= auto_control_xing_in_a_bits_data[3:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'hE & _out_out_bits_data_WIRE_29 & (&_out_womask_T_4))	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_extradel_coarse <= auto_control_xing_in_a_bits_data[11:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:2] == 5'hF & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        ctrl_sampledel_sd <= auto_control_xing_in_a_bits_data[4:0];	// @[RegisterRouter.scala:83:24, TLSPI.scala:67:17]
      if (out_woready_26 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
  ...
  SPIFIFO fifo (	// @[TLSPI.scala:68:20]
    ...
    .io_tx_valid        (out_woready_10 & auto_control_xing_in_a_bits_mask[0] & ~quash),	// @[Bitwise.scala:28:17, RegMapFIFO.scala:18:{30,33}, :26:26, RegisterRouter.scala:83:24]
    .io_tx_bits         (auto_control_xing_in_a_bits_data[7:0]),	// @[RegisterRouter.scala:83:24]
    .io_rx_ready        (_out_wofireMux_T & out_front_bits_read & out_backSel_19 & _out_out_bits_data_WIRE_29 & auto_control_xing_in_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:72:36, :83:24]
  ...
  assign auto_control_xing_in_d_bits_data = _GEN[auto_control_xing_in_a_bits_address[6:2]] ? _GEN_0[auto_control_xing_in_a_bits_address[6:2]] : 32'h0;	// @[Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
endmodule
