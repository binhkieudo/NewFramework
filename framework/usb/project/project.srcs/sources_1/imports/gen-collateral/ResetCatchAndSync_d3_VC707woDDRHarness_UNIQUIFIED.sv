...
module ResetCatchAndSync_d3_VC707woDDRHarness_UNIQUIFIED(
  input  clock,
         reset,
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_VC707woDDRHarness_UNIQUIFIED io_sync_reset_chain (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
