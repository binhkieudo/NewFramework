...
module ScratchpadSlavePort(
  ...
  reg  [10:0]     acq_source;	// @[ScratchpadSlavePort.scala:55:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        acq_source = _RANDOM_0[21:11];	// @[ScratchpadSlavePort.scala:46:24, :55:18]
        acq_address = {_RANDOM_0[31:22], _RANDOM_1[21:0]};	// @[ScratchpadSlavePort.scala:46:24, :55:18]
        acq_mask = _RANDOM_1[25:22];	// @[ScratchpadSlavePort.scala:55:18]
        acq_data = {_RANDOM_1[31:26], _RANDOM_2[25:0]};	// @[ScratchpadSlavePort.scala:55:18]
        bundleIn_0_d_bits_data_r = {_RANDOM_2[31:27], _RANDOM_3[26:0]};	// @[Reg.scala:19:16, ScratchpadSlavePort.scala:55:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
