...
module Rocket(
  ...
  wire [31:0]      _rf_ext_R0_data;	// @[RocketCore.scala:1145:15]
  wire [31:0]      _rf_ext_R1_data;	// @[RocketCore.scala:1145:15]
  ...
  wire [31:0]      id_rs_0 = rf_wen & (|rf_waddr) & rf_waddr == _ibuf_io_inst_0_bits_inst_rs1 ? coreMonitorBundle_wrdata : _rf_ext_R0_data;	// @[RocketCore.scala:286:20, :765:23, :766:21, :767:21, :772:17, :1145:15, :1152:19, :1157:{16,25}, :1160:{20,31,39}]
  wire [31:0]      id_rs_1 = rf_wen & (|rf_waddr) & rf_waddr == _ibuf_io_inst_0_bits_inst_rs2 ? coreMonitorBundle_wrdata : _rf_ext_R1_data;	// @[RocketCore.scala:286:20, :765:23, :766:21, :767:21, :772:17, :1145:15, :1152:19, :1157:{16,25}, :1160:{20,31,39}]
  ...
  wire [31:0]      _T_143 = r & ~(ll_wen ? 32'h1 << ll_waddr : 32'h0);	// @[RocketCore.scala:744:29, :745:27, :755:44, :759:14, :760:12, :1127:{62,64}, :1132:40, :1135:{49,58}, package.scala:16:47]
  ...
  always @(posedge clock) begin
    ...
    if (ctrl_killd) begin	// @[RocketCore.scala:909:104]
      ...
      if (id_illegal_insn) begin	// @[RocketCore.scala:340:99]
        ...
        ex_reg_rs_msb_0 <= id_rs_0[31:2];	// @[RocketCore.scala:413:26, :546:38, :772:17, :1152:19, :1157:25, :1160:{31,39}]
      end
    ...
    if (~ctrl_killd & _T_52)	// @[RocketCore.scala:413:26, :495:19, :500:22, :544:{23,38}, :546:26, :909:104]
      ex_reg_rs_msb_1 <= id_rs_1[31:2];	// @[RocketCore.scala:413:26, :546:38, :772:17, :1152:19, :1157:25, :1160:{31,39}]
    ...
    if (reset) begin
      ...
      if (ll_wen | _T_145)	// @[RocketCore.scala:745:27, :755:44, :760:12, :855:28, :1138:17]
        _r <= _T_143 | (_T_145 ? 32'h1 << wb_reg_inst[11:7] : 32'h0);	// @[RocketCore.scala:275:24, :401:29, :855:28, :1126:60, :1127:62, :1131:29, :1135:{49,58}, package.scala:16:47]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _r = {_RANDOM_26[31:21], _RANDOM_27[20:0]};	// @[RocketCore.scala:413:26, :1131:29]
        dcache_blocked_blocked = _RANDOM_27[21];	// @[RocketCore.scala:889:22, :1131:29]
        rocc_blocked = _RANDOM_27[22];	// @[RocketCore.scala:893:25, :1131:29]
        coreMonitorBundle_rd0val_REG = {_RANDOM_27[31:25], _RANDOM_28[24:0]};	// @[RocketCore.scala:1025:46, :1131:29]
  ...
  CSRFile csr (	// @[RocketCore.scala:315:19]
    ...
    .io_cause                   (wb_reg_xcpt ? wb_reg_cause : {27'h0, _T_91 ? 5'hF : _T_93 ? 5'hD : _T_95 ? 5'h17 : _T_97 ? 5'h15 : {2'h0, _T_99 ? 3'h7 : _T_101 ? 3'h5 : {1'h1, _T_103, 1'h0}}}),	// @[Mux.scala:47:70, RocketCore.scala:265:35, :268:35, :703:34, :704:34, :705:34, :706:34, :707:34, :708:34, :709:34, :1167:24, package.scala:16:47]
    .io_pc                      (wb_reg_pc),	// @[RocketCore.scala:270:22]
    .io_tval                    (wb_xcpt & (~wb_reg_xcpt | wb_reg_cause == 32'h3 | wb_reg_cause == 32'h1 | wb_reg_cause == 32'hC | _csr_io_htval_htval_valid_imem_T | wb_reg_cause == 32'h2) ? wb_reg_wdata : 32'h0),	// @[RocketCore.scala:265:35, :268:35, :277:25, :789:24, :792:32, :793:{28,46}, :795:21, :1104:26, package.scala:16:47]
  ...
  assign io_imem_req_bits_pc = wb_xcpt | _csr_io_eret ? _csr_io_evec : replay_wb ? wb_reg_pc : _mem_npc_T_3;	// @[RocketCore.scala:270:22, :315:19, :589:129, :732:36, :914:{8,17}, :915:8, :1104:26]
