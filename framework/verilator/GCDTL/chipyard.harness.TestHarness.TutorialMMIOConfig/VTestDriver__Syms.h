...
class VTestDriver__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__gcd__monitor;
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_pbus__coupler_to_gcd__fragmenter;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_pbus__coupler_to_gcd__fragmenter__monitor;
