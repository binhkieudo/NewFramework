...
extern "C" void* memory_init(long long mem_size, long long word_size, long long line_size, long long id_bits, long long clock_hz, long long mem_base);

VL_INLINE_OPT void VTestDriver___024unit____Vdpiimwrap_memory_init_TOP____024unit(QData/*63:0*/ mem_size, QData/*63:0*/ word_size, QData/*63:0*/ line_size, QData/*63:0*/ id_bits, QData/*63:0*/ clock_hz, QData/*63:0*/ mem_base, QData/*63:0*/ &memory_init__Vfuncrtn) {
    ...
    memory_init__Vfuncrtn__Vcvt = memory_init(mem_size__Vcvt, word_size__Vcvt, line_size__Vcvt, id_bits__Vcvt, clock_hz__Vcvt, mem_base__Vcvt);
    memory_init__Vfuncrtn = VL_CVT_VP_Q(memory_init__Vfuncrtn__Vcvt);
}

extern "C" void memory_tick(void* channel, svBit reset, svBit ar_valid, svBit* ar_ready, long long ar_addr, int ar_id, int ar_size, int ar_len, svBit aw_valid, svBit* aw_ready, long long aw_addr, int aw_id, int aw_size, int aw_len, svBit w_valid, svBit* w_ready, int w_strb, long long w_data, svBit w_last, svBit* r_valid, svBit r_ready, int* r_id, int* r_resp, long long* r_data, svBit* r_last, svBit* b_valid, svBit b_ready, int* b_id, int* b_resp);

VL_INLINE_OPT void VTestDriver___024unit____Vdpiimwrap_memory_tick_TOP____024unit(QData/*63:0*/ channel, CData/*0:0*/ reset, CData/*0:0*/ ar_valid, CData/*0:0*/ &ar_ready, QData/*63:0*/ ar_addr, IData/*31:0*/ ar_id, IData/*31:0*/ ar_size, IData/*31:0*/ ar_len, CData/*0:0*/ aw_valid, CData/*0:0*/ &aw_ready, QData/*63:0*/ aw_addr, IData/*31:0*/ aw_id, IData/*31:0*/ aw_size, IData/*31:0*/ aw_len, CData/*0:0*/ w_valid, CData/*0:0*/ &w_ready, IData/*31:0*/ w_strb, QData/*63:0*/ w_data, CData/*0:0*/ w_last, CData/*0:0*/ &r_valid, CData/*0:0*/ r_ready, IData/*31:0*/ &r_id, IData/*31:0*/ &r_resp, QData/*63:0*/ &r_data, CData/*0:0*/ &r_last, CData/*0:0*/ &b_valid, CData/*0:0*/ b_ready, IData/*31:0*/ &b_id, IData/*31:0*/ &b_resp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VTestDriver___024unit____Vdpiimwrap_memory_tick_TOP____024unit\n"); );
    // Body
    void* channel__Vcvt;
...
extern "C" int tsi_tick(svBit tsi_out_valid, svBit* tsi_out_ready, int tsi_out_bits, svBit* tsi_in_valid, svBit tsi_in_ready, int* tsi_in_bits);

VL_INLINE_OPT void VTestDriver___024unit____Vdpiimwrap_tsi_tick_TOP____024unit(CData/*0:0*/ tsi_out_valid, CData/*0:0*/ &tsi_out_ready, IData/*31:0*/ tsi_out_bits, CData/*0:0*/ &tsi_in_valid, CData/*0:0*/ tsi_in_ready, IData/*31:0*/ &tsi_in_bits, IData/*31:0*/ &tsi_tick__Vfuncrtn) {
    ...
    tsi_tick__Vfuncrtn__Vcvt = tsi_tick(tsi_out_valid__Vcvt, &tsi_out_ready__Vcvt, tsi_out_bits__Vcvt, &tsi_in_valid__Vcvt, tsi_in_ready__Vcvt, &tsi_in_bits__Vcvt);
