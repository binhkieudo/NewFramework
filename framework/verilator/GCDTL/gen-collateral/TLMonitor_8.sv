...
module TLMonitor_8(
  ...
  wire         _T_864 = _T_940 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire [514:0] _a_opcodes_set_T_1 = {511'h0, _T_864 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [526:0] _d_sizes_clr_T_5 = 527'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [514:0] _a_sizes_set_T_1 = {511'h0, _T_864 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire         _T_1013 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_879 = _T_1013 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_864 ? _a_set_T[32:0] : 33'h0)) & ~(_T_879 ? _d_clr_T[32:0] : 33'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_864 ? _a_opcodes_set_T_1[131:0] : 132'h0)) & ~(_T_879 ? _d_opcodes_clr_T_5[131:0] : 132'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_864 ? _a_sizes_set_T_1[131:0] : 132'h0)) & ~(_T_879 ? _d_sizes_clr_T_5[131:0] : 132'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_940 | _T_1013)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_940 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1013 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_809 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire             _T_833 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    ...
    wire             _T_912 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    ...
    wire             _GEN_28 = _T_883 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_883 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _T_969 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [32:0]     _T_865 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [32:0]     _T_884 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [32:0]     _T_970 = 33'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & ~(io_in_a_bits_size[2]) & (io_in_a_bits_address[30:12] == 19'h1 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & ~(io_in_a_bits_size[2]) & (io_in_a_bits_address[30:12] == 19'h1 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_912 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_912 & ~d_release_ack ? _d_clr_wo_ready_T[32:0] : 33'h0) | a_set_wo_ready == 33'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_969 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :747:42, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:30:44)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
