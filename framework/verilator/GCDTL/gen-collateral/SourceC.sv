...
module SourceC(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_tag = _RANDOM_0[29:18];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_set = {_RANDOM_0[31:30], _RANDOM_1[7:0]};	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_way = _RANDOM_1[10:8];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_1[12];	// @[Reg.scala:19:16, SourceC.scala:94:25]
        s2_req_opcode = _RANDOM_1[15:13];	// @[Reg.scala:19:16]
        s2_req_param = _RANDOM_1[18:16];	// @[Reg.scala:19:16]
        s2_req_source = _RANDOM_1[21:19];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:22], _RANDOM_2[1:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_2[11:2];	// @[Reg.scala:19:16]
        s3_valid = _RANDOM_2[20];	// @[Reg.scala:19:16, SourceC.scala:100:25]
        s3_req_opcode = _RANDOM_2[23:21];	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_2[26:24];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_2[29:27];	// @[Reg.scala:19:16]
  ...
  Queue_41 queue (	// @[SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
