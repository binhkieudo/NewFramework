...
module DigitalTop(
  ...
  wire        _gcd_auto_in_a_ready;	// @[GCD.scala:177:29]
  wire        _gcd_auto_in_d_valid;	// @[GCD.scala:177:29]
  wire [2:0]  _gcd_auto_in_d_bits_opcode;	// @[GCD.scala:177:29]
  wire [1:0]  _gcd_auto_in_d_bits_size;	// @[GCD.scala:177:29]
  wire [9:0]  _gcd_auto_in_d_bits_source;	// @[GCD.scala:177:29]
  wire [63:0] _gcd_auto_in_d_bits_data;	// @[GCD.scala:177:29]
  ...
  wire        _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_valid;	// @[PeripheryBus.scala:31:26]
  wire [2:0]  _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_opcode;	// @[PeripheryBus.scala:31:26]
  wire [2:0]  _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_param;	// @[PeripheryBus.scala:31:26]
  wire [1:0]  _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_size;	// @[PeripheryBus.scala:31:26]
  wire [9:0]  _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  wire [12:0] _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_address;	// @[PeripheryBus.scala:31:26]
  wire [7:0]  _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_mask;	// @[PeripheryBus.scala:31:26]
  wire [63:0] _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_data;	// @[PeripheryBus.scala:31:26]
  wire        _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt;	// @[PeripheryBus.scala:31:26]
  wire        _subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_d_ready;	// @[PeripheryBus.scala:31:26]
  ...
  PeripheryBus subsystem_pbus (	// @[PeripheryBus.scala:31:26]
    .auto_coupler_to_gcd_fragmenter_out_a_ready                          (_gcd_auto_in_a_ready),	// @[GCD.scala:177:29]
    .auto_coupler_to_gcd_fragmenter_out_d_valid                          (_gcd_auto_in_d_valid),	// @[GCD.scala:177:29]
    .auto_coupler_to_gcd_fragmenter_out_d_bits_opcode                    (_gcd_auto_in_d_bits_opcode),	// @[GCD.scala:177:29]
    .auto_coupler_to_gcd_fragmenter_out_d_bits_size                      (_gcd_auto_in_d_bits_size),	// @[GCD.scala:177:29]
    .auto_coupler_to_gcd_fragmenter_out_d_bits_source                    (_gcd_auto_in_d_bits_source),	// @[GCD.scala:177:29]
    .auto_coupler_to_gcd_fragmenter_out_d_bits_data                      (_gcd_auto_in_d_bits_data),	// @[GCD.scala:177:29]
    ...
    .auto_coupler_to_gcd_fragmenter_out_a_valid                          (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_valid),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_opcode                    (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_opcode),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_param                     (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_param),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_size                      (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_size),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_source                    (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_source),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_address                   (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_address),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_mask                      (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_mask),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_data                      (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_data),
    .auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt                   (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt),
    .auto_coupler_to_gcd_fragmenter_out_d_ready                          (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_d_ready),
  ...
  GCDTL gcd (	// @[GCD.scala:177:29]
    .clock                  (clock),
    .reset                  (reset),
    .auto_in_a_valid        (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_valid),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_opcode  (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_opcode),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_param   (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_param),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_size    (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_size),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_source  (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_source),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_address (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_address),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_mask    (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_mask),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_data    (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_data),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_bits_corrupt (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt),	// @[PeripheryBus.scala:31:26]
    .auto_in_d_ready        (_subsystem_pbus_auto_coupler_to_gcd_fragmenter_out_d_ready),	// @[PeripheryBus.scala:31:26]
    .auto_in_a_ready        (_gcd_auto_in_a_ready),
    .auto_in_d_valid        (_gcd_auto_in_d_valid),
    .auto_in_d_bits_opcode  (_gcd_auto_in_d_bits_opcode),
    .auto_in_d_bits_size    (_gcd_auto_in_d_bits_size),
    .auto_in_d_bits_source  (_gcd_auto_in_d_bits_source),
    .auto_in_d_bits_data    (_gcd_auto_in_d_bits_data)
  );
