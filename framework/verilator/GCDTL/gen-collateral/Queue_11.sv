...
module Queue_11(
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[37:30];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[101:38];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[102];	// @[Decoupled.scala:273:95]
endmodule
