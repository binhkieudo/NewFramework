...
module TLFragmenter_2(
  ...
  wire [12:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:264:30]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {7'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
