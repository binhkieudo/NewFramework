...
module TLMonitor_42(
  ...
  wire        _T_2542 = io_in_e_ready & io_in_e_valid;	// @[Decoupled.scala:51:35]
  ...
  wire [34:0] _a_opcodes_set_T_1 = {31'h0, _T_2377 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {31'h0, io_in_a_bits_source, 2'h0};	// @[Edges.scala:231:25, Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Mux.scala:27:73]
  wire [46:0] _d_sizes_clr_T_5 = 47'hFF << _GEN_7;	// @[Monitor.scala:678:74]
  wire [35:0] _a_sizes_set_T_1 = {31'h0, _T_2377 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {31'h0, io_in_a_bits_source, 3'h0};	// @[Edges.scala:231:25, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  wire [35:0] _c_sizes_set_T_1 = {31'h0, _T_2466 ? {io_in_c_bits_size, 1'h1} : 5'h0} << {31'h0, io_in_c_bits_source, 3'h0};	// @[Edges.scala:231:25, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :656:54, :752:40, :760:{38,72}, :763:{28,51}, :765:52]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_2 <= (inflight_2 | d_set) & ~(_T_2542 ? 8'h1 << _GEN_5 : 8'h0);	// @[Decoupled.scala:51:35, Monitor.scala:636:33, :825:27, :830:25, :831:72, :832:13, :836:25, :837:73, :838:13, :844:{27,36,38}, OneHot.scala:57:35]
    end
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_32 = {io_in_b_bits_source == 2'h2, io_in_b_bits_source == 2'h1} != io_in_b_bits_source;	// @[Monitor.scala:165:113, Mux.scala:27:73, Parameters.scala:46:9]
    ...
    wire             _GEN_35 = io_in_b_valid & io_in_b_bits_opcode == 3'h0;	// @[Misc.scala:201:34, Monitor.scala:187:{25,53}]
    ...
    wire             _GEN_47 = io_in_c_valid & io_in_c_bits_opcode == 3'h0;	// @[Misc.scala:201:34, Monitor.scala:278:{25,51}]
    wire             _GEN_48 = io_in_c_valid & io_in_c_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:286:{25,55}]
    ...
    wire  [23:0]     _GEN_50 = {19'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire             _GEN_52 = _T_2396 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_53 = _T_2396 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [2:0]      _T_2397 = inflight >> _GEN_51;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [2:0]      _T_2483 = inflight_1 >> _GEN_51;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_31 & ~reset & _GEN_32) begin	// @[Monitor.scala:49:11, :165:113, :167:47]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_31 & ~reset & _GEN_33) begin	// @[Monitor.scala:49:11, :167:47, :173:27]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_34 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :177:45]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'B' channel Get carries source that is not first source (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_34 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :177:45]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_35 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :187:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'B' channel PutFull carries source that is not first source (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_35 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :187:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_36 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :196:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_36 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :196:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_37 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :205:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_37 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :205:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_38 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :214:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'B' channel Logical carries source that is not first source (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_38 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :214:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_39 & ~reset & _GEN_32) begin	// @[Monitor.scala:42:11, :165:113, :223:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'B' channel Hint carries source that is not first source (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_39 & ~reset & (|_GEN_30)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :223:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_41 & ~reset & ~source_ok_2) begin	// @[Monitor.scala:42:11, :242:50, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_43 & ~reset & ~source_ok_2) begin	// @[Monitor.scala:42:11, :251:54, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_44 & ~reset & ~(_T_1964 & (_WIRE_8_0 | _source_ok_WIRE_2_1 | _source_ok_WIRE_2_2) & _T_1955 & io_in_c_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :259:49, :260:78, Parameters.scala:46:9, :91:48, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel carries Release type unsupported by manager (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_44 & ~reset & ~(_WIRE_8_0 & _T_1955 & _T_1964 & (io_in_c_bits_address[31:13] == 19'h0 | io_in_c_bits_address[31:12] == 20'h3 | io_in_c_bits_address[31:12] == 20'h4 | io_in_c_bits_address[31:16] == 16'h1 | _GEN_45 == 19'h0 | io_in_c_bits_address[31:16] == 16'h200 | io_in_c_bits_address[31:12] == 20'h2010 | io_in_c_bits_address[31:26] == 6'h3 | io_in_c_bits_address[31:12] == 20'h54000 | io_in_c_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :259:49, :261:78, :638:40, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_44 & ~reset & ~source_ok_2) begin	// @[Monitor.scala:42:11, :259:49, Parameters.scala:1126:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_46 & ~reset & ~(_T_2140 & (_WIRE_8_0 | _source_ok_WIRE_2_1 | _source_ok_WIRE_2_2) & _T_2131 & io_in_c_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :269:53, :270:78, Parameters.scala:46:9, :91:48, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel carries ReleaseData type unsupported by manager (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_46 & ~reset & ~(_WIRE_8_0 & _T_2131 & _T_2140 & (io_in_c_bits_address[31:13] == 19'h0 | io_in_c_bits_address[31:12] == 20'h3 | io_in_c_bits_address[31:12] == 20'h4 | io_in_c_bits_address[31:16] == 16'h1 | _GEN_45 == 19'h0 | io_in_c_bits_address[31:16] == 16'h200 | io_in_c_bits_address[31:12] == 20'h2010 | io_in_c_bits_address[31:26] == 6'h3 | io_in_c_bits_address[31:12] == 20'h54000 | io_in_c_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :269:53, :271:78, :638:40, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel carries Release from a client which does not support Probe (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      ...
      if (_GEN_46 & ~reset & _GEN_42) begin	// @[Monitor.scala:42:11, :245:30, :269:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel ReleaseData smaller than a beat (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_46 & ~reset & (|_GEN_40)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :269:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_47 & ~reset & (|_GEN_40)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :278:51]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_48 & ~reset & (|_GEN_40)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :286:55]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_49 & ~reset & (|_GEN_40)) begin	// @[Edges.scala:21:{16,24}, Monitor.scala:42:11, :293:49]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_2482 & ~same_cycle_resp_1 & ~reset & _GEN_54 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :691:36, :747:{21,42}, :791:71, :792:88, :794:30, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:61:80)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (_T_2542 & ~reset & ~(_T_2544[0])) begin	// @[Decoupled.scala:51:35, Monitor.scala:42:11, :839:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
