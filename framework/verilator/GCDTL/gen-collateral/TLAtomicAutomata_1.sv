...
module TLAtomicAutomata_1(
  ...
  wire [5:0]      _GEN = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[16], auto_in_a_bits_address[14], ~(auto_in_a_bits_address[12])};	// @[Parameters.scala:137:{31,45}]
  wire [5:0]      _GEN_0 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26:25], auto_in_a_bits_address[16], ~(auto_in_a_bits_address[14]), auto_in_a_bits_address[12]};	// @[Parameters.scala:137:{31,45}]
  wire [5:0]      _GEN_1 = auto_in_a_bits_address[30:25] ^ 6'h22;	// @[Parameters.scala:137:31]
  wire [5:0]      _GEN_2 = {_GEN_1[5], _GEN_1[1:0], auto_in_a_bits_address[16], auto_in_a_bits_address[14], auto_in_a_bits_address[12]};	// @[Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 6'h0 | _GEN_0 == 6'h0 | _GEN_2 == 6'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 6'h0 | _GEN_0 == 6'h0 | _GEN_2 == 6'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Bundles.scala:259:74, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :671:54, :672:42]
