...
module PeripheryBus(
  input         auto_coupler_to_gcd_fragmenter_out_a_ready,
                auto_coupler_to_gcd_fragmenter_out_d_valid,
  input  [2:0]  auto_coupler_to_gcd_fragmenter_out_d_bits_opcode,
  input  [1:0]  auto_coupler_to_gcd_fragmenter_out_d_bits_size,
  input  [9:0]  auto_coupler_to_gcd_fragmenter_out_d_bits_source,
  input  [63:0] auto_coupler_to_gcd_fragmenter_out_d_bits_data,
  ...
  output        auto_coupler_to_gcd_fragmenter_out_a_valid,
  output [2:0]  auto_coupler_to_gcd_fragmenter_out_a_bits_opcode,
                auto_coupler_to_gcd_fragmenter_out_a_bits_param,
  output [1:0]  auto_coupler_to_gcd_fragmenter_out_a_bits_size,
  output [9:0]  auto_coupler_to_gcd_fragmenter_out_a_bits_source,
  output [12:0] auto_coupler_to_gcd_fragmenter_out_a_bits_address,
  output [7:0]  auto_coupler_to_gcd_fragmenter_out_a_bits_mask,
  output [63:0] auto_coupler_to_gcd_fragmenter_out_a_bits_data,
  output        auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt,
                auto_coupler_to_gcd_fragmenter_out_d_ready,
  ...
  wire        _coupler_to_gcd_auto_tl_in_a_ready;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_gcd_auto_tl_in_d_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_gcd_auto_tl_in_d_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_gcd_auto_tl_in_d_bits_size;	// @[LazyModule.scala:489:27]
  wire [5:0]  _coupler_to_gcd_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [63:0] _coupler_to_gcd_auto_tl_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire [12:0] _out_xbar_auto_out_2_a_bits_address;	// @[PeripheryBus.scala:50:30]
  ...
  TLXbar_2 out_xbar (	// @[PeripheryBus.scala:50:30]
    ...
    .auto_out_2_a_ready        (_coupler_to_gcd_auto_tl_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_valid        (_coupler_to_gcd_auto_tl_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_opcode  (_coupler_to_gcd_auto_tl_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_size    (_coupler_to_gcd_auto_tl_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_source  (_coupler_to_gcd_auto_tl_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_data    (_coupler_to_gcd_auto_tl_in_d_bits_data),	// @[LazyModule.scala:489:27]
  ...
  TLInterconnectCoupler_6 coupler_to_gcd (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_fragmenter_out_a_ready        (auto_coupler_to_gcd_fragmenter_out_a_ready),
    .auto_fragmenter_out_d_valid        (auto_coupler_to_gcd_fragmenter_out_d_valid),
    .auto_fragmenter_out_d_bits_opcode  (auto_coupler_to_gcd_fragmenter_out_d_bits_opcode),
    .auto_fragmenter_out_d_bits_size    (auto_coupler_to_gcd_fragmenter_out_d_bits_size),
    .auto_fragmenter_out_d_bits_source  (auto_coupler_to_gcd_fragmenter_out_d_bits_source),
    .auto_fragmenter_out_d_bits_data    (auto_coupler_to_gcd_fragmenter_out_d_bits_data),
    ...
    .auto_fragmenter_out_a_valid        (auto_coupler_to_gcd_fragmenter_out_a_valid),
    .auto_fragmenter_out_a_bits_opcode  (auto_coupler_to_gcd_fragmenter_out_a_bits_opcode),
    .auto_fragmenter_out_a_bits_param   (auto_coupler_to_gcd_fragmenter_out_a_bits_param),
    .auto_fragmenter_out_a_bits_size    (auto_coupler_to_gcd_fragmenter_out_a_bits_size),
    .auto_fragmenter_out_a_bits_source  (auto_coupler_to_gcd_fragmenter_out_a_bits_source),
    .auto_fragmenter_out_a_bits_address (auto_coupler_to_gcd_fragmenter_out_a_bits_address),
    .auto_fragmenter_out_a_bits_mask    (auto_coupler_to_gcd_fragmenter_out_a_bits_mask),
    .auto_fragmenter_out_a_bits_data    (auto_coupler_to_gcd_fragmenter_out_a_bits_data),
    .auto_fragmenter_out_a_bits_corrupt (auto_coupler_to_gcd_fragmenter_out_a_bits_corrupt),
    .auto_fragmenter_out_d_ready        (auto_coupler_to_gcd_fragmenter_out_d_ready),
    .auto_tl_in_a_ready                 (_coupler_to_gcd_auto_tl_in_a_ready),
    .auto_tl_in_d_valid                 (_coupler_to_gcd_auto_tl_in_d_valid),
    .auto_tl_in_d_bits_opcode           (_coupler_to_gcd_auto_tl_in_d_bits_opcode),
    .auto_tl_in_d_bits_size             (_coupler_to_gcd_auto_tl_in_d_bits_size),
    .auto_tl_in_d_bits_source           (_coupler_to_gcd_auto_tl_in_d_bits_source),
    .auto_tl_in_d_bits_data             (_coupler_to_gcd_auto_tl_in_d_bits_data)
  );
