...
module SourceD(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[22:18];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        ...
        s2_req_source = _RANDOM_2[27:23];	// @[Reg.scala:19:16, SourceD.scala:90:32]
        ...
        s3_req_source = _RANDOM_7[10:6];	// @[Reg.scala:19:16]
  ...
  Queue_42 queue (	// @[SourceD.scala:120:21]
    .clock            (clock),
    .reset            (reset),
