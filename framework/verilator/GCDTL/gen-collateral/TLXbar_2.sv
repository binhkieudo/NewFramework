...
module TLXbar_2(
  ...
  output [12:0] auto_out_2_a_bits_address,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[30], ~(auto_in_a_bits_address[14])} == 2'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_1 = {~(auto_in_a_bits_address[30]), auto_in_a_bits_address[14]} == 2'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[30], auto_in_a_bits_address[14]} == 2'h0;	// @[Parameters.scala:137:{45,65}]
  wire        _portsAOI_in_0_a_ready_WIRE = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready | requestAIO_0_2 & auto_out_2_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  ...
  wire [2:0]  readys_readys = ~({readys_mask[2], _readys_filter_T_1[2] | readys_mask[1], _GEN[1] | readys_mask[0]} & {_GEN[0] | _readys_filter_T_1[2], auto_out_2_d_valid | _readys_filter_T_1[0] | _GEN[1], auto_out_1_d_valid | auto_out_2_d_valid | _GEN[0]});	// @[Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43]
  ...
  wire [5:0]  out_12_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 6'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 6'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 6'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {2'h0, auto_in_d_ready & out_12_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[5:3];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[6];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[7];	// @[Arbiter.scala:88:30, :117:26]
        state_2 = _RANDOM_0[8];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_2_a_bits_address = auto_in_a_bits_address[12:0];	// @[BundleMap.scala:247:19]
