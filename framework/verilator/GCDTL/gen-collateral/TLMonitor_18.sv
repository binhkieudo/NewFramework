...
module TLMonitor_18(
  ...
  wire         _T_1321 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1252 = _T_1321 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire         _T_1389 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1267 = _T_1389 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1321) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1321 | _T_1389)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1321 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1389 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [17:0]     _GEN_13 = {io_in_a_bits_address[30:14], ~(io_in_a_bits_address[12])};	// @[Parameters.scala:137:{31,45}]
    ...
    wire             _GEN_26 = _T_1271 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire             _T_1350 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [32:0]     _T_1253 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [32:0]     _T_1272 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [263:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire  [32:0]     _T_1351 = 33'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_4 & ~reset & ~_T_408) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~_T_408) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_667 & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & (_T_667 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (io_in_a_bits_address[30:13] == 18'h0 | io_in_a_bits_address[30:12] == 19'h4 | _GEN_5 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (_GEN_13 == 18'h0 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (_GEN_13 == 18'h0 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & _GEN_9) begin	// @[Monitor.scala:42:11, :110:30, :138:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & _GEN_9) begin	// @[Monitor.scala:42:11, :110:30, :146:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1350 & ~reset & ~(_T_1351[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:53:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1350 & ~reset & _GEN_28 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:53:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
