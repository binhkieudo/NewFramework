...
module TLMonitor_17(
  ...
  wire        _T_1062 = io_in_d_valid & ~(|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  always @(posedge clock) begin
    ...
    if (_T_1062) begin	// @[Monitor.scala:549:20]
    ...
    source_1 <= ~_T_1062 & source_1;	// @[Monitor.scala:538:22, :549:{20,32}, :553:15]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire             _T_1036 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    wire             _T_1115 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire             _T_1086 = _T_1115 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    wire             _GEN_10 = _T_1086 & io_in_a_valid;	// @[Monitor.scala:680:71, :684:30]
    wire             _GEN_11 = _T_1086 & ~io_in_a_valid;	// @[Monitor.scala:680:71, :684:30]
    wire             _T_1172 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_T_1086 & ~reset & ~(inflight | io_in_a_valid)) begin	// @[Monitor.scala:49:11, :611:27, :680:71, :682:49]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1115 & io_in_a_valid & ~d_release_ack & ~reset & ~io_in_a_ready) begin	// @[Monitor.scala:49:11, :670:46, :671:{26,74}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(io_in_a_valid != (_T_1115 & ~d_release_ack) | ~io_in_a_valid)) begin	// @[Monitor.scala:49:11, :670:46, :671:{26,71,74}, :699:{29,48,51}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1172 & ~reset) begin	// @[Monitor.scala:49:11, :791:71]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at BusWrapper.scala:90:33)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1172 & ~reset & (|io_in_d_bits_size)) begin	// @[Monitor.scala:49:11, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at BusWrapper.scala:90:33)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
